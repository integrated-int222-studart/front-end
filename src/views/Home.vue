    ...
    <div class="w-full">
      <div class="flex max-h-screen md:h-screen">
        ...
        <div class="hidden lg:block lg:w-1/2">
          <div class="h-full ">
            <img
              class="w-full object-cover lg:w-full lg:h-full"
    ...
    <div class="flex items-center justify-center bg-black">
      <div class="md:w-10/12 w-full px-4 text-white flex flex-col">
        <div class="flex flex-col">
          <div class="flex mt-12 mb-12 flex-row justify-between items-center">
            <div class="">
              <img src="../assets/images/logo-white.png" class="h-40" />
            </div>
            <a
              class="md:block cursor-pointer text-gray-600 hover:text-white uppercase"
              >About</a
            >
            <a
              class="md:block cursor-pointer text-gray-600 hover:text-white uppercase"
